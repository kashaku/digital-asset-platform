...
import { useMarketAssets } from '@/hooks/useMarketAssets.ts';
        ...
        <section className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600 sm:text-base">
              浏览已上架的数字资产，查看价格、创作者、Token ID、IPFS CID 与版税比例。后续接入合约后，购买与出价按钮将触发真实链上交易。
            </p>
          </div>

          <div className="rounded-2xl border bg-white px-5 py-4 shadow-sm">
            <p className="text-xs text-slate-500">当前网络</p>
            <p className="mt-1 text-sm font-semibold text-slate-950">Polygon / Chain ID 137</p>
          </div>
        </section>
